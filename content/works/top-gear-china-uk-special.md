  ...
  "caseStudy": [
    {
      ...
      "text": {
        "en": "Bring an internationally recognizable factual-entertainment format into a Chinese broadcast context while working across teams, languages, locations, and production expectations.",
        "zh": "把國際知名紀實娛樂節目格式放進中國電視播出語境，同時處理跨團隊、跨語言、跨地點與跨製作習慣的協作。"
      }
    },
    {
