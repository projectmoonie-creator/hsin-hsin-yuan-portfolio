...
test("renderPage creates bilingual page with scroll-stack works and video fallbacks", () => {
  ...
  assert.match(html, /<link rel="preload" as="image" type="image\/avif" href="\/assets\/portfolio\/hero\/hsin-working-white-space-1280\.avif" imagesrcset="[^"]*960\.avif 960w, [^"]*1280\.avif 1280w" imagesizes="\(min-width: 1281px\) 47vw, 90vw" media="\(min-width: 821px\)" fetchpriority="high">/);
  ...
  assert.match(html, /<source type="image\/webp" media="\(min-width: 821px\)" srcset="[^"]*960\.webp 960w, [^"]*1280\.webp 1280w" sizes="\(min-width: 1281px\) 47vw, 90vw">/);
  assert.match(html, /<source type="image\/jpeg" media="\(max-width: 820px\)" srcset="[^"]*640\.jpg 640w, [^"]*960\.jpg 960w" sizes="90vw">/);
  assert.match(html, /<img class="hero-media-image" src="\/assets\/portfolio\/hsin-working-white-space\.jpg" width="1280" height="960" alt="Hsin-Hsin Yuan working on a laptop in a bright white studio" loading="eager" decoding="sync" fetchpriority="high">/);
  ...
  assert.match(html, /data-hero-width="1280" data-hero-height="960"/);
